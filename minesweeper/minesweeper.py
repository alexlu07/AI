        ...
        while True:
            ...
            for sentence in self.knowledge:
                if sentence.cells == set():
                    ...
                    continue
                mines_list = sentence.known_mines()
                mines = copy.deepcopy(mines_list)
                if mines:
                    x += len(mines)
                    for mine in mines:
                        self.mark_mine(mine)
                safes_list = sentence.known_safes()
                safes = copy.deepcopy(safes_list)
                if safes:
                    x += len(safes)
                    for safe in safes:
                        self.mark_safe(safe)
